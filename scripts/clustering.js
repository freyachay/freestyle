(function(){
    ...
    window.RAP.lafayette = function(t){
        document.getElementById("lyrics").value = "Iâ€™m takin' this horse by the reins makinâ€™\nRedcoats redder with bloodstains\nAnd Iâ€™m never gonna stop until I make â€˜em\nDrop and burn â€˜em up and scatter their remains";
        document.getElementById("fader").value = 2;
    };
